...
images:
  [
    'https://raw.githubusercontent.com/sanderdejong88/io-technology/develop/public/articles/performance-testing-real-time-data-in-javascript/hero.svg',
  ]
...
<div className="my-12 flex flex-col items-center md:-mx-32" style={{ backgroundColor: '#f9fafb' }}>
  <img
    src="https://raw.githubusercontent.com/sanderdejong88/io-technology/develop/public/articles/performance-testing-real-time-data-in-javascript/0-performance-testing-javascript.png"
...
<div className="my-12 flex flex-col items-center md:-mx-32" style={{ backgroundColor: '#f9fafb' }}>
  <img
    src="https://raw.githubusercontent.com/sanderdejong88/io-technology/develop/public/articles/performance-testing-real-time-data-in-javascript/1-performance-testing-javascript.png"
...
<div className="my-12 flex flex-col items-center md:-mx-32" style={{ backgroundColor: '#f9fafb' }}>
  <img
    src="https://raw.githubusercontent.com/sanderdejong88/io-technology/develop/public/articles/performance-testing-real-time-data-in-javascript/2-performance-testing-javascript.png"
    alt="Configuring performance test"
    style={{ backgroundColor: '#f9fafb', margin: '0' }}
  />
</div>
...
<div className="my-12 flex flex-col items-center md:-mx-32" style={{ backgroundColor: '#f9fafb' }}>
  <img
    src="https://raw.githubusercontent.com/sanderdejong88/io-technology/develop/public/articles/performance-testing-real-time-data-in-javascript/3-performance-testing-javascript.png"
    alt="WebSocket"
    style={{ backgroundColor: '#f9fafb', margin: '0' }}
  />
</div>
...
<div className="my-12 flex flex-col items-center md:-mx-32" style={{ backgroundColor: '#f9fafb' }}>
  <img
    src="https://raw.githubusercontent.com/sanderdejong88/io-technology/develop/public/articles/performance-testing-real-time-data-in-javascript/4-performance-testing-javascript.png"
    alt="WebSocket"
    style={{ backgroundColor: '#f9fafb', margin: '0' }}
  />
</div>
